...
const oe = [
		() =>
			k(
				() => import('../nodes/0.6d717b5a.js'),
				[
					'../nodes/0.6d717b5a.js',
					'../chunks/index.fb970b68.js',
					'../chunks/stores.75b92f33.js',
					'../chunks/singletons.4f040f5d.js',
					'../chunks/index.562a36d8.js',
		...
		() =>
			k(
				...
				[
					...
					'../chunks/singletons.4f040f5d.js',
					'../chunks/index.562a36d8.js',
					'../assets/4.9d501049.css'
				],
				import.meta.url
			),
		() =>
			k(
				() => import('../nodes/5.cb1c5030.js'),
				[
					'../nodes/5.cb1c5030.js',
					'../chunks/environment.9aa685ef.js',
					'../chunks/index.fb970b68.js',
					'../assets/5.89a9e780.css'
				],
				import.meta.url
			)
	],
	ae = [0],
	le = { '/': [2], '/about': [3], '/sverdle': [-5], '/sverdle/how-to-play': [5] },
	fe = {
		handleError: ({ error: a }) => {
			console.error(a);
		}

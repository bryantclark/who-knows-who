...
const oe = [
		() =>
			g(
				() => import('../nodes/0.ef6c217c.js'),
				[
					'../nodes/0.ef6c217c.js',
					'../chunks/index.cc8e466b.js',
					'../chunks/stores.be7445a2.js',
					'../chunks/singletons.0d712f08.js',
		...
		() =>
			g(
				() => import('../nodes/2.3e9ca05e.js'),
				[
					'../nodes/2.3e9ca05e.js',
					'../chunks/index.cc8e466b.js',
					'../chunks/GraphScore.38630396.js',
					'../assets/GraphScore.30ac1e92.css',
					'../assets/2.57239003.css'
				],
				import.meta.url
			),
		() =>
		...
		() =>
			g(
				() => import('../nodes/4.3e4aae02.js'),
				[
					'../nodes/4.3e4aae02.js',
					'../chunks/index.cc8e466b.js',
					'../chunks/GraphScore.38630396.js',
					'../assets/GraphScore.30ac1e92.css',
					'../assets/4.13aa8076.css'
				],
				import.meta.url
			),
		() =>
			g(
				() => import('../nodes/5.316311b0.js'),
				[
					'../nodes/5.316311b0.js',
					'../chunks/index.cc8e466b.js',
	...
	ae = [0],
	le = { '/': [2], '/about': [3], '/game': [-5], '/sverdle': [-6], '/sverdle/how-to-play': [6] },
	fe = {
		handleError: ({ error: a }) => {
			console.error(a);
		}

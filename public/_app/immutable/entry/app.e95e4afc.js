...
const oe = [
		() =>
			g(
				() => import('../nodes/0.3c68001b.js'),
				[
					'../nodes/0.3c68001b.js',
					'../chunks/index.1eb2484a.js',
					'../chunks/stores.158298c3.js',
					'../chunks/singletons.83f7da0e.js',
					'../chunks/index.2783d2dd.js',
		...
		() =>
			g(
				() => import('../nodes/4.517230a9.js'),
				[
					'../nodes/4.517230a9.js',
					'../chunks/index.1eb2484a.js',
					'../chunks/forms.f21909fe.js',
					'../chunks/parse.bee59afc.js',
					'../chunks/singletons.83f7da0e.js',
					'../chunks/index.2783d2dd.js',
					'../assets/4.770d9618.css'
				],
				import.meta.url
			),
		() =>
			g(
				() => import('../nodes/5.10d3ba48.js'),
				[
					'../nodes/5.10d3ba48.js',
					'../chunks/index.1eb2484a.js',
					'../chunks/forms.f21909fe.js',
	...
	ae = [0],
	le = { '/': [2], '/about': [3], '/contact': [4], '/sverdle': [-6], '/sverdle/how-to-play': [6] },
	fe = {
		handleError: ({ error: a }) => {
			console.error(a);
		}

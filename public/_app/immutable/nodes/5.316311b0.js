...
import { j as Fe, k as Ie, r as Ve } from '../chunks/singletons.0d712f08.js';
const qe = (a, e = {}) => {
	de(e);
	let {
...
const je = '(prefers-reduced-motion: reduce)',
	et = () => window.matchMedia(je).matches,
	tt = Ve(et(), (a) => {
		{
			const e = (r) => {
					a(r.matches);
				},
				t = window.matchMedia(je);
			return (
...
function ge(a, e) {
	...
	return {
		...
		l(f) {
			t = T(f, 'DIV', { class: !0 });
			var i = H(t);
			((o = j(i, r)), (n = X(i)), (s = T(i, 'SPAN', { class: !0 })));
			var h = H(s);
			(u.l(h),
				h.forEach(b),
				(l = X(i)),
...
function ye(a, e) {
	...
	return {
		...
		first: null,
		c() {
			((t = W('h2')), (r = M('Row ')), (n = M(o)), (s = O()), (l = W('div')));
...
function it(a) {
	...
	return {
		c() {
			(s && s.c(), (e = O()), (t = W('button')), (o = M(r)), (n = M(' play again?')), this.h());
		},
		l(l) {
			(s && s.l(l),
				(e = X(l)),
			...
			var c = H(t);
			((o = j(c, r)), (n = j(c, ' play again?')), c.forEach(b), this.h());
		},
		h() {
			(y(t, 'data-key', 'enter'),
...
function we(a) {
	...
	return {
		c() {
			((e = W('p')), (t = M('the answer was "')), (o = M(r)), (n = M('"')));
		},
		l(s) {
			e = T(s, 'P', {});
			var l = H(e);
			((t = j(l, 'the answer was "')), (o = j(l, r)), (n = j(l, '"')), l.forEach(b));
		},
		m(s, l) {
...
function ct(a) {
	...
	return {
		...
		l(d) {
			...
			var te = H(l);
			((c = j(te, 'How to play')), te.forEach(b), (p = X(F)), (m = T(F, 'DIV', { class: !0 })));
			var ae = H(m);

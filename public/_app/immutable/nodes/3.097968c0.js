import { d as V } from '../chunks/environment.9aa685ef.js';
import {
	S as N,
	i as Q,
	s as U,
...
function $(R) {
	let i, T, t, m, k, A, c, x, u, P, M, J, f, K, q, g, H, j, h, B, v, L, O;
	return {
		c() {
			((i = o('meta')),
				(T = _()),
				...
				(u = o('a')),
				(P = r('SvelteKit')),
				(M = r(` app. You can make your own by typing the
		following into your command line and following the prompts:`)),
				(J = _()),
				(f = o('pre')),
				(K = r('npm create svelte@latest')),
				(q = _()),
				(g = o('p')),
				(H =
		...
		following into your command line and following the prompts:`
				...
				(f = l(n, 'PRE', {})));
			var D = p(f);
			((K = s(D, 'npm create svelte@latest')), D.forEach(a), (q = w(n)), (g = l(n, 'P', {})));
			var F = p(g);
			((H = s(
				F,

import { G as b, s as w } from './index.cc8e466b.js';
const u = [];
function x(e, t) {
...
var h;
const A = ((h = globalThis.__sveltekit_1ggd97h) == null ? void 0 : h.base) ?? '';
var k;
const R = ((k = globalThis.__sveltekit_1ggd97h) == null ? void 0 : k.assets) ?? A,
	S = '1733949663090',
	O = 'sveltekit:snapshot',
	U = 'sveltekit:scroll',
	L = 'sveltekit:index',
	p = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 },
	m = location.origin;
function N(e) {
	let t = e.baseURI;
	if (!t) {
...
const K = { url: g({}), page: g({}), navigating: d(null), updated: T() };
export {
	L as I,
	p as P,
	U as S,

...
import { j as E, k as w } from './singletons.83f7da0e.js';
...
function F(t, i = () => {}) {
	const l = async ({ action: e, result: c, reset: n = !0, invalidateAll: r = !0 }) => {
		(c.type === 'success' && (n && HTMLFormElement.prototype.reset.call(t), r && (await L())),

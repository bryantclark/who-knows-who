...
window.fetch = (e, t) => (
	(e instanceof Request ? e.method : t?.method || 'GET') !== 'GET' && W.delete(Oe(e)),
	Ut(e, t)
);
const W = new Map();
function It(e, t) {
	...
	if (r?.textContent) {
		...
		return (
			i && W.set(n, { body: a, init: o, ttl: 1e3 * Number(i) }),
...
function jt({ nodes: e, server_loads: t, dictionary: n, matchers: r }) {
	...
	return Object.entries(n).map(([s, [c, f, u]]) => {
		const { pattern: h, params: p } = Ct(s),
			l = {
				id: s,
				exec: (d) => {
					const v = h.exec(d);
					if (v) return Ot(v, p, r);
				},
...
const L = globalThis.__sveltekit_116osk3?.base ?? '',
	$t = globalThis.__sveltekit_116osk3?.assets ?? L ?? '',
	Dt = '1763929151147',
	rt = 'sveltekit:snapshot',
	at = 'sveltekit:scroll',
	ot = 'sveltekit:states',
...
function Re(e, t, n) {
	...
	const a = e instanceof SVGAElement ? e.target.baseVal : e.target,
		o = !r || !!a || me(r, t, n) || (e.getAttribute('rel') || '').split(/\s+/).includes('external'),
	...
	function a(o, i = !1) {
		...
		if (!s || typeof s != 'object') r[o] = s;
			...
			if (typeof s[0] == 'string') {
				...
				if (f) {
					let u = s[1];
					return (typeof u != 'number' && (u = n.push(s[1]) - 1), (r[o] = f(a(u))));
				}
				switch (c) {
					case 'Date':
						r[o] = new Date(s[1]);
					...
					case 'Set':
						const u = new Set();
						r[o] = u;
						for (let l = 1; l < s.length; l += 1) u.add(a(s[l]));
						break;
					case 'Map':
						const h = new Map();
						r[o] = h;
						for (let l = 1; l < s.length; l += 2) h.set(a(s[l]), a(s[l + 1]));
						break;
					case 'RegExp':
					...
					case 'null':
						...
						r[o] = p;
						for (let l = 1; l < s.length; l += 2) p[s[l]] = a(s[l + 1]);
						break;
					case 'Int8Array':
					case 'Uint8Array':
					...
					case 'BigUint64Array': {
						const l = globalThis[c],
							d = new l(a(s[1]));
						r[o] = s[2] !== void 0 ? d.subarray(s[2], s[3]) : d;
						break;
					}
					case 'ArrayBuffer': {
						const l = s[1],
					...
					case 'URLSearchParams': {
						const l = new URLSearchParams(s[1]);
						r[o] = l;
						break;
					}
					default:
...
const lt = new Set(['load', 'prerender', 'csr', 'ssr', 'trailingSlash', 'config']);
[...lt];
const Xt = new Set([...lt]);
[...Xt];
function Zt(e) {
...
function se(e) {
	return e instanceof ge || e instanceof Ne ? e.status : 500;
}
function tn(e) {
	return e instanceof Ne ? e.text : 'Internal Error';
}
let R, X, Ee;
const nn = We.toString().includes('$$') || /function \w+\(\) \{\}/.test(We.toString());
nn
	? ((R = {
			data: {},
			form: null,
...
const rn = '/__data.json',
	an = '.html__data.json';
function on(e) {
	return e.endsWith('.html') ? e.replace(/\.html$/, an) : e.replace(/\/$/, '') + rn;
}
const sn = new Set(['icon', 'shortcut icon', 'apple-touch-icon']),
	V = nt(at) ?? {},
	Z = nt(rt) ?? {},
	D = { url: Xe({}), page: Xe({}), navigating: Ce(null), updated: Vt() };
function De(e) {
	V[e] = _e();
}
function cn(e, t) {
...
async function Un(e, t, n) {
	(globalThis.__sveltekit_116osk3?.data && globalThis.__sveltekit_116osk3.data,
		...
		(A = history.state?.[M]),
		(I = history.state?.[J]),
		A || ((A = I = Date.now()), history.replaceState({ ...history.state, [M]: A, [J]: I }, '')));
	const r = V[A];
	function a() {
	...
	(n
		...
		: (await q({
				type: 'enter',
				url: je(k.hash ? kn(new URL(location.href)) : location.href),
				replace_state: !0
			}),
			a()),
		yn());
}
async function fn(e = !0, t = !0) {
	...
	if (
		...
		if (!o || n !== $) return;
		if (o.type === 'redirect')
			return Fe(new URL(o.location, m.url).href, { replaceState: !0 }, 1, n);
		(t || (o.props.page.state = a), $e(o.props.page), (m = o.state), Le(), we.$set(o.props));
	} else Le();
	await Promise.all([...de.values()].map(({ resource: a }) => a)).catch(Te);
}
function Le() {
	((ce.length = 0), (te = !1));
}
...
async function Fe(e, t, n, r) {
	...
	(t.invalidateAll && fe(),
		await q({
			...
			nav_token: r,
			accept: () => {
				(t.invalidateAll && ((te = !0), (a = [...de.keys()])),
					t.invalidate && t.invalidate.forEach(wn));
			}
		}),
		t.invalidateAll &&
			ae()
				.then(ae)
				.then(() => {
					de.forEach(({ resource: o }, i) => {
						a?.includes(i) && o.refresh?.();
					});
				}));
}
async function un(e) {
		...
		if (
			...
			(T = {
				...
				promise: Ge({ ...e, preload: t }).then(
					(n) => (z.delete(t), n.type === 'loaded' && n.state.error && fe(), n)
				),
				fork: null
			}),
			He)
			...
			n.fork = n.promise.then((r) => {
				if (n === T && r.type === 'loaded')
					try {
						return He(() => {
							(we.$set(r.props), $e(r.props.page));
						});
					} catch {}
				return null;
			});
...
async function gt(e, t, n) {
	...
	if (
		...
		(we = new k.root({
			target: t,
			props: { ...e.props, stores: D, components: le },
			hydrate: n,
			sync: !1
		})),
...
function he({ url: e, params: t, branch: n, status: r, error: a, route: o, form: i }) {
	let s = 'never';
	if (L && (e.pathname === L || e.pathname === L + '/')) s = 'always';
	else for (const l of n) l?.slash !== void 0 && (s = l.slash);
	((e.pathname = kt(e.pathname, s)), (e.search = e.search));
	const c = {
		type: 'loaded',
		state: { url: e, params: t, branch: n, error: a, route: o },
		props: { constructors: Zt(n).map((l) => l.node.component), page: Ke(R) }
	};
	...
	return (
		(!m.url || e.href !== m.url.href || m.error !== a || (i !== void 0 && i !== R.form) || u) &&
			(c.props.page = {
				error: a,
				params: t,
				route: { id: o?.id ?? null },
...
async function Me({ loader: e, parent: t, url: n, params: r, route: a, server_data_node: o }) {
	let i = null;
	const s = {
...
function dn(e, t, n) {
	...
	const o = ue ? Lt(r, a.href, t) : It(r, t);
	return { resolved: a, promise: o };
}
...
function tt({ error: e, url: t, route: n, params: r }) {
	return {
		...
		props: { page: Ke(R), constructors: [] }
	};
}
async function Ge({ id: e, invalidating: t, url: n, params: r, route: a, preload: o }) {
	if (T?.id === e) return (z.delete(T.token), T.promise);
	const { errors: i, layouts: s, leaf: c } = a,
		f = [...s, c];
	(i.forEach((_) => _?.().catch(() => {})), f.forEach((_) => _?.[1]().catch(() => {})));
	let u = null;
	const h = m.url ? e !== pe(m.url) : !1,
	...
	let d = !1;
	{
		const _ = f.map((w, b) => {
			const S = m.branch[b],
				y = !!w?.[0] && (S?.loader !== w[1] || et(d, p, h, l, S.server?.uses, r));
			return (y && (d = !0), y);
		});
		if (_.some(Boolean)) {
			try {
				...
				const b = await G(w, { url: n, params: r, route: { id: e } });
				return z.has(o)
					? tt({ error: b, url: n, params: r, route: a })
					: ye({ status: se(w), error: b, url: n, route: a });
			}
	...
	const v = u?.nodes;
	let E = !1;
	const g = f.map(async (_, w) => {
		if (!_) return;
		const b = m.branch[w],
			S = v?.[w];
		if ((!S || S.type === 'skip') && _[1] === b?.loader && !et(E, p, h, l, b.universal?.uses, r))
			return b;
		if (((E = !0), S?.type === 'error')) throw S;
		return Me({
			loader: _[1],
			url: n,
			params: r,
			...
			parent: async () => {
				const C = {};
				for (let U = 0; U < w; U += 1) Object.assign(C, (await g[U])?.data);
				return C;
			},
			server_data_node: qe(
	...
	for (let _ = 0; _ < f.length; _ += 1)
		if (f[_])
			try {
				...
				if (w instanceof xe) return { type: 'redirect', location: w.location };
				if (z.has(o))
					return tt({
						error: await G(w, { params: r, url: n, route: { id: a.id } }),
						url: n,
						params: r,
						route: a
					});
				let b = se(w),
					S;
				if (v?.includes(w)) ((b = w.status ?? b), (S = w.error));
				else if (w instanceof ge) S = w.body;
				else {
					if (await D.updated.check()) return (await ft(), await Y(n));
					S = await G(w, { params: r, url: n, route: { id: a.id } });
				}
				const y = await pn(_, P, i);
				return y
					? he({
							url: n,
							params: r,
...
async function ye({ status: e, error: t, url: n, route: r }) {
	const a = {};
	let o = null;
	if (k.server_loads[0] === 0)
		try {
			const s = await wt(n, [!0]);
			if (s.type !== 'data' || (s.nodes[0] && s.nodes[0].type !== 'data')) throw 0;
			o = s.nodes[0] ?? null;
		} catch {
			(n.origin !== ee || n.pathname !== location.pathname || Ve) && (await Y(n));
		}
	try {
		const i = await Me({
				loader: Ue,
				...
				server_data_node: qe(o)
			}),
			s = { node: await ie(), loader: ie, universal: null, server: null, data: null };
		return he({ url: n, params: a, branch: [i, s], status: e, error: t, route: null });
	} catch (i) {
		if (i instanceof xe) return Fe(new URL(i.location, location.href), {}, 0);
		throw i;
	}
}
async function gn(e) {
	...
	try {
		const r = (async () => {
			let a =
				(await k.hooks.reroute({ url: new URL(e), fetch: async (o, i) => dn(o, i, e).promise })) ??
				e;
			if (typeof a == 'string') {
				const o = new URL(e);
				(k.hash ? (o.hash = a) : (o.pathname = a), (a = o));
			}
			return a;
		})();
...
async function ne(e, t) {
	if (e && !me(e, L, k.hash)) {
		...
		for (const a of Be) {
			const o = a.exec(r);
			if (o) return { id: pe(e), invalidating: t, route: a, params: St(o), url: e };
		}
	}
}
function _n(e) {
	return (
		Et(k.hash ? e.hash.replace(/^#/, '').replace(/[?#].+/, '') : e.pathname.slice(L.length)) || '/'
	);
}
function pe(e) {
	return (k.hash ? e.hash.replace(/^#/, '') : e.pathname) + e.search;
}
function _t({ url: e, type: t, intent: n, delta: r, event: a }) {
	let o = !1;
	const i = Ye(m, n, e, t);
	...
	return (Q || ut.forEach((c) => c(s)), o ? null : i);
}
async function q({
	type: e,
	url: t,
	...
	const l = await ne(t, !1),
		d =
			e === 'enter'
				? Ye(m, l, t, e)
				: _t({ url: t, type: e, delta: n?.delta, intent: l, event: h });
	if (!d) {
		(u(), $ === c && ($ = p));
		return;
	}
	...
	(f(),
		(Q = !0),
		ue && d.navigation.type !== 'enter' && D.navigating.set((X.current = d.navigation)));
	let g = l && (await Ge(l));
	if (!g) {
		if (me(t, L, k.hash)) return await Y(t, o);
		g = await mt(
			t,
			{ id: null },
			await G(new Ne(404, 'Not Found', `Not found: ${t.pathname}`), {
				url: t,
				params: {},
				route: { id: null }
			}),
	...
	if (((t = l?.url || t), $ !== c)) return (d.reject(new Error('navigation aborted')), !1);
	if (g.type === 'redirect') {
		if (s < 20) {
			(await q({
				type: e,
	...
	} else g.props.page.status >= 400 && (await D.updated.check()) && (await ft(), await Y(t, o));
	if (
		(Le(),
		De(v),
		ht(E),
		...
		const y = o ? 0 : 1,
			C = { [M]: (A += y), [J]: (I += y), [ot]: i };
		((o ? history.replaceState : history.pushState).call(history, C, '', t), o || cn(A, I));
	}
	const P = l && T?.id === l.id ? T.fork : null;
	((T = null), (g.props.page.state = i));
	let _;
	if (ue) {
		const y = (await Promise.all(Array.from(ln, (U) => U(d.navigation)))).filter(
			(U) => typeof U == 'function'
		);
		if (y.length > 0) {
			let U = function () {
		...
		const C = P && (await P);
		(C ? (_ = C.commit()) : (we.$set(g.props), $e(g.props.page), (_ = bt?.())), (dt = !0));
	} else await gt(g, Ie, !1);
	const { activeElement: w } = document;
	(await _, await ae(), await ae());
	let b = n ? n.scroll : a ? _e() : null;
	if (Ze) {
		const y = t.hash && document.getElementById(vt(t));
		if (b) scrollTo(b.x, b.y);
		else if (y) {
			y.scrollIntoView();
			const { top: C, left: U } = y.getBoundingClientRect();
			b = { x: pageXOffset + U, y: pageYOffset + C };
		} else scrollTo(0, 0);
	}
	const S = document.activeElement !== w && document.activeElement !== document.body;
	(!r && !S && bn(t, b),
		(Ze = !0),
		g.props.page && Object.assign(R, g.props.page),
		(Q = !1),
		e === 'popstate' && pt(I),
		d.fulfil(void 0),
		H.forEach((y) => y(d.navigation)),
		D.navigating.set((X.current = null)));
}
async function mt(e, t, n, r, a) {
	return e.origin === ee && e.pathname === location.pathname && !Ve
		? await ye({ status: r, error: n, url: e, route: t })
		: await Y(e, a);
}
function mn() {
	let e, t, n;
	...
	function r(s) {
		s.defaultPrevented || o(s.composedPath()[0], B.tap);
	}
	(j.addEventListener('mousedown', r), j.addEventListener('touchstart', r, { passive: !0 }));
	const a = new IntersectionObserver(
		(s) => {
			for (const c of s) c.isIntersecting && (Ae(new URL(c.target.href)), a.unobserve(c.target));
		},
		{ threshold: 0 }
	);
	async function o(s, c) {
		const f = it(s, j),
			u = f === t && c >= n;
		if (!f || u) return;
		const { url: h, external: p, download: l } = Re(f, L, k.hash);
		if (p || l) return;
		const d = oe(f),
			v = h && pe(m.url) === pe(h);
		if (!(d.reload || v))
			if (c <= d.preload_data) {
				((t = f), (n = B.tap));
				const E = await ne(h, !1);
				if (!E) return;
				un(E);
			} else c <= d.preload_code && ((t = f), (n = c), Ae(h));
	}
	function i() {
		a.disconnect();
		for (const s of j.querySelectorAll('a')) {
			const { url: c, external: f, download: u } = Re(s, L, k.hash);
			if (f || u) continue;
			const h = oe(s);
			h.reload ||
				(h.preload_code === B.viewport && a.observe(s), h.preload_code === B.eager && Ae(c));
		}
	}
	(H.add(i), i());
}
...
function In(e, t = {}) {
	return (
		(e = new URL(je(e))),
		e.origin !== ee ? Promise.reject(new Error('goto: invalid URL')) : Fe(e, t, 0)
	);
}
function wn(e) {
...
function yn() {
	((history.scrollRestoration = 'manual'),
		addEventListener('beforeunload', (t) => {
			let n = !1;
			if ((Qe(), !Q)) {
				const r = Ye(m, void 0, null, 'leave'),
					a = {
						...r.navigation,
						cancel: () => {
		...
		j.addEventListener('click', async (t) => {
			if (
				...
				return;
			const n = it(t.composedPath()[0], j);
			if (!n) return;
			const { url: r, external: a, target: o, download: i } = Re(n, L, k.hash);
			if (!r) return;
			if (o === '_parent' || o === '_top') {
			...
			if (
				...
				return;
			const [f, u] = (k.hash ? r.hash.replace(/^#/, '') : r.href).split('#'),
				h = f === be(location);
			if (a || (s.reload && (!h || !u))) {
				_t({ url: r, type: 'link', event: t }) ? (Q = !0) : t.preventDefault();
				return;
			}
			if (u !== void 0 && h) {
				...
				if (((K = !0), De(A), e(r), !s.replace_state)) return;
				K = !1;
			}
			(t.preventDefault(),
				await new Promise((p) => {
			...
			if (!Pe) {
				if (t.state?.[M]) {
					...
					const r = V[n],
						...
						i = t.state[J],
						s = m.url ? be(location) === be(m.url) : !1;
					if (i === I && (dt || s)) {
						(a !== R.state && (R.state = a), e(o), (V[A] = _e()), r && scrollTo(r.x, r.y), (A = n));
						return;
					}
					const f = n - A;
					await q({
		...
		addEventListener('hashchange', () => {
			K &&
				((K = !1), history.replaceState({ ...history.state, [M]: ++A, [J]: I }, '', location.href));
		}));
	for (const t of document.querySelectorAll('link')) sn.has(t.rel) && (t.href = t.href);
	addEventListener('pageshow', (t) => {
		t.persisted && D.navigating.set((X.current = null));
	});
	function e(t) {
		((m.url = R.url = t), D.page.set(Ke(R)), D.page.notify());
	}
}
async function vn(
	e,
	{ status: t = 200, error: n, node_ids: r, params: a, route: o, server_route: i, data: s, form: c }
) {
	Ve = !0;
	const f = new URL(location.href);
	let u;
	(({ params: a = {}, route: o = { id: null } } = (await ne(f, !1)) || {}),
		(u = Be.find(({ id: l }) => l === o.id)));
	let h,
		p = !0;
	try {
		const l = r.map(async (v, E) => {
				const g = s[E];
				return (
					g?.uses && (g.uses = yt(g.uses)),
					Me({
						loader: k.nodes[v],
						url: f,
						params: a,
						...
						parent: async () => {
							const P = {};
							for (let _ = 0; _ < E; _ += 1) Object.assign(P, (await l[_]).data);
							return P;
						},
						server_data_node: qe(g)
					})
				);
			}),
		...
		if (u) {
			const v = u.layouts;
			for (let E = 0; E < v.length; E++) v[E] || d.splice(E, 0, void 0);
		}
		h = he({ url: f, params: a, branch: d, status: t, error: n, form: c, route: u ?? null });
	} catch (l) {
		if (l instanceof xe) {
		...
		((h = await ye({
			status: se(l),
			error: await G(l, { url: f, params: a, route: o }),
			url: f,
			route: o
		})),
			(e.textContent = ''),
	...
	(h.props.page && (h.props.page.state = {}), await gt(h, e, p));
}
async function wt(e, t) {
	const n = new URL(e);
	((n.pathname = on(e.pathname)),
		e.pathname.endsWith('/') && n.searchParams.append(en, '1'),
		n.searchParams.append(Qt, t.map((o) => (o ? '1' : '0')).join('')));
...
`);
				...
				if (((f = f.slice(p + 1)), l.type === 'redirect')) return o(l);
				if (l.type === 'data')
					(l.nodes?.forEach((d) => {
						d?.type === 'data' && ((d.uses = yt(d.uses)), (d.data = c(d.data)));
					}),
						o(l));
				else if (l.type === 'chunk') {
					const { id: d, data: v, error: E } = l,
						g = i.get(d);
					(i.delete(d), E ? g.reject(c(E)) : g.fulfil(c(v)));
				}
			}
		}
	});
...
function bn(e, t = null) {
	...
	if (n) n.focus();
		...
		if (a && a.type !== 'None') {
			const o = [];
			for (let i = 0; i < a.rangeCount; i += 1) o.push(a.getRangeAt(i));
			setTimeout(() => {
				if (a.rangeCount === o.length) {
...
export { Un as a, In as g, Ln as i, Sn as l, R as p, D as s };
